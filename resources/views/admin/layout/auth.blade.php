...
<head>
    ...
    <!-- Base Css Files -->
    <link href="{{ url('admin/libs/jqueryui/ui-lightness/jquery-ui-1.10.4.custom.min.css') }} " rel="stylesheet" />
    <link href="{{ url('admin/libs/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/fontello/css/fontello.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/animate-css/animate.min.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/nifty-modal/css/component.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/magnific-popup/magnific-popup.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/ios7-switch/ios7-switch.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/pace/pace.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/sortable/sortable-theme-bootstrap.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/bootstrap-datepicker/css/datepicker.css') }}" rel="stylesheet" />
    <link href="{{ url('admin/libs/jquery-icheck/skins/all.css') }}" rel="stylesheet" />
    <!-- Code Highlighter for Demo -->
    <!--        <link href="{{ url('admin/libs/prettify/github.css') }}" rel="stylesheet" />-->

    <!-- Extra CSS Libraries Start -->
    <link href="{{ url('admin/libs/rickshaw/rickshaw.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/morrischart/morris.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/jquery-clock/clock.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/bootstrap-calendar/css/bic_calendar.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/sortable/sortable-theme-bootstrap.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/jquery-weather/simpleweather.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ url('admin/libs/bootstrap-xeditable/css/bootstrap-editable.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link rel="apple-touch-icon" href="{{ url('admin/img/apple-touch-icon.png') }} " />
    <link rel="apple-touch-icon" sizes="57x57" href="url('admin/img/apple-touch-icon-57x57.png') }}" />
    <link rel="apple-touch-icon" sizes="72x72" href="url('admin/img/apple-touch-icon-72x72.png') }}" />
    <link rel="apple-touch-icon" sizes="76x76" href="url('admin/img/apple-touch-icon-76x76.png') }}" />
    <link rel="apple-touch-icon" sizes="114x114" href="url('admin/img/apple-touch-icon-114x114.png') }}" />
    <link rel="apple-touch-icon" sizes="120x120" href="url('admin/img/apple-touch-icon-120x120.png') }}" />
    <link rel="apple-touch-icon" sizes="144x144" href="url('admin/img/apple-touch-icon-144x144.png') }}" />
    <link rel="apple-touch-icon" sizes="152x152" href="url('admin/img/apple-touch-icon-152x152.png') }}" />
    <script>
...
-->
                            ...
                            <li class="dropdown topbar-profile">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src=" {{ url('admin/images/users/user-35.jpg') }}"></span> {{ Auth::user()->name }}<strong></strong> <i class="fa fa-caret-down"></i></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{ url('/admin/logout') }}" onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();"><i class="icon-logout-1"></i> Logout</a></li>
...
-->
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        <li><a href="{{ url('admin/home') }}"><i class='icon-home-3'></i><span>Dashboard</span> <span class="pull-right"></span></a>
                        </li>
                        
                        <li><a href="{{ url('admin/edit-categories') }}"><i class='glyphicon glyphicon-th-large'></i><span>Product Categories</span> <span class="pull-right"></span></a>
                        </li>
                        
                        <li><a href="{{ url('admin/edit-products') }}"><i class='fa fa-star'></i><span>Product Listing</span> <span class="pull-right"></span></a>
                        </li>
                        
                        <li><a href="{{ url('admin/add-special-products') }}"><i class='fa fa-bell'></i><span>Special Offers</span> <span class="pull-right"></span></a>
                        </li>
                        
                        <li><a href="{{ url('admin/add-popular-products') }}"><i class='fa fa-bullhorn'></i><span>Popular Offers</span> <span class="pull-right"></span></a>
                        </li>
...
-->
    ...
    <script src="{{ url('admin/libs/jquery/jquery-1.11.1.min.js') }} "></script>
    <script src="{{ url('admin/libs/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ url('admin/libs/jqueryui/jquery-ui-1.10.4.custom.min.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-ui-touch/jquery.ui.touch-punch.min.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-detectmobile/detect.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-animate-numbers/jquery.animateNumbers.js') }}"></script>
    <script src="{{ url('admin/libs/ios7-switch/ios7.switch.js') }}"></script>
    <script src="{{ url('admin/libs/fastclick/fastclick.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-blockui/jquery.blockUI.js') }}"></script>
    <script src="{{ url('admin/libs/bootstrap-bootbox/bootbox.min.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-slimscroll/jquery.slimscroll.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-sparkline/jquery-sparkline.js') }}"></script>
    <script src="{{ url('admin/libs/nifty-modal/js/classie.js') }}"></script>
    <script src="{{ url('admin/libs/nifty-modal/js/modalEffects.js') }}"></script>
    <script src="{{ url('admin/libs/sortable/sortable.min.js') }}"></script>
    <script src="{{ url('admin/libs/bootstrap-fileinput/bootstrap.file-input.js') }}"></script>
    <script src="{{ url('admin/libs/bootstrap-select/bootstrap-select.min.js') }}"></script>
    <script src="{{ url('admin/libs/bootstrap-select2/select2.min.js') }}"></script>
    <script src="{{ url('admin/libs/magnific-popup/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ url('admin/libs/pace/pace.min.js') }}"></script>
    <script src="{{ url('admin/libs/bootstrap-datepicker/js/bootstrap-datepicker.js') }}"></script>
    <script src="{{ url('admin/libs/jquery-icheck/icheck.min.js') }}"></script>
    <script src="{{ url('admin/js/init.js') }} "></script>
    <!-- Demo Specific JS Libraries -->
    <!--  	<script src="{{ url('admin/libs/prettify/prettify.js') }} "></script>-->
    <script>
